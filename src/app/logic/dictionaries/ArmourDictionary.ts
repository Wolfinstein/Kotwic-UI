...
export class ArmourDictionary {
  private static legsCache: Prefix[] | null = null;
  ...
  static getLegsPrefix(
    ...
    const prefixes = this.initializeLegsPrefix();
  ...
  private static initializeLegsPrefix(): Prefix[] {
    if (this.legsCache) return this.legsCache;

    const prefixes: Prefix[] = [];

    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.ZWYKLY, PrefixType.PIKOWANY, Stats.builder().obronaPrzedmiotow(3).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOBRY, PrefixType.PIKOWANY, Stats.builder().obronaPrzedmiotow(5).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOSKONALY, PrefixType.PIKOWANY, Stats.builder().obronaPrzedmiotow(6).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY, PrefixType.PIKOWANY, Stats.builder().obronaPrzedmiotow(5).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOBRY, PrefixType.PIKOWANY, Stats.builder().obronaPrzedmiotow(7).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOSKONALY, PrefixType.PIKOWANY, Stats.builder().obronaPrzedmiotow(9).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.EPICKI, PrefixType.PIKOWANY, Stats.builder().obronaPrzedmiotow(11).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.ZWYKLY, PrefixType.WZMOCNIONY, Stats.builder().obronaPrzedmiotow(5).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOBRY, PrefixType.WZMOCNIONY, Stats.builder().obronaPrzedmiotow(8).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOSKONALY, PrefixType.WZMOCNIONY, Stats.builder().obronaPrzedmiotow(10).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY, PrefixType.WZMOCNIONY, Stats.builder().obronaPrzedmiotow(7).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOBRY, PrefixType.WZMOCNIONY, Stats.builder().obronaPrzedmiotow(11).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOSKONALY, PrefixType.WZMOCNIONY, Stats.builder().obronaPrzedmiotow(14).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.EPICKI, PrefixType.WZMOCNIONY, Stats.builder().obronaPrzedmiotow(18).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.ZWYKLY, PrefixType.CWIEKOWANY, Stats.builder().obronaPrzedmiotow(7).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOBRY, PrefixType.CWIEKOWANY, Stats.builder().obronaPrzedmiotow(11).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOSKONALY, PrefixType.CWIEKOWANY, Stats.builder().obronaPrzedmiotow(14).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY, PrefixType.CWIEKOWANY, Stats.builder().obronaPrzedmiotow(10).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOBRY, PrefixType.CWIEKOWANY, Stats.builder().obronaPrzedmiotow(15).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOSKONALY, PrefixType.CWIEKOWANY, Stats.builder().obronaPrzedmiotow(19).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.EPICKI, PrefixType.CWIEKOWANY, Stats.builder().obronaPrzedmiotow(25).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.ZWYKLY, PrefixType.LEKKI, Stats.builder().zwinnosc(2).obronaPrzedmiotow(2).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOBRY, PrefixType.LEKKI, Stats.builder().zwinnosc(3).obronaPrzedmiotow(3).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOSKONALY, PrefixType.LEKKI, Stats.builder().zwinnosc(4).obronaPrzedmiotow(4).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY, PrefixType.LEKKI, Stats.builder().zwinnosc(3).obronaPrzedmiotow(3).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOBRY, PrefixType.LEKKI, Stats.builder().zwinnosc(5).obronaPrzedmiotow(5).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOSKONALY, PrefixType.LEKKI, Stats.builder().zwinnosc(6).obronaPrzedmiotow(6).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.EPICKI, PrefixType.LEKKI, Stats.builder().zwinnosc(7).obronaPrzedmiotow(7).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.ZWYKLY, PrefixType.KROTKIE, Stats.builder().zwinnosc(2).obronaPrzedmiotow(-1).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOBRY, PrefixType.KROTKIE, Stats.builder().zwinnosc(3).obronaPrzedmiotow(-1).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOSKONALY, PrefixType.KROTKIE, Stats.builder().zwinnosc(4).obronaPrzedmiotow(-1).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY, PrefixType.KROTKIE, Stats.builder().zwinnosc(3).obronaPrzedmiotow(-1).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOBRY, PrefixType.KROTKIE, Stats.builder().zwinnosc(5).obronaPrzedmiotow(-1).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOSKONALY, PrefixType.KROTKIE, Stats.builder().zwinnosc(6).obronaPrzedmiotow(-1).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.EPICKI, PrefixType.KROTKIE, Stats.builder().zwinnosc(7).obronaPrzedmiotow(-1).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.ZWYKLY, PrefixType.AKSAMITNE, Stats.builder().wyglad(2).obronaPrzedmiotow(-6).wplywy(3).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOBRY, PrefixType.AKSAMITNE, Stats.builder().wyglad(3).obronaPrzedmiotow(-6).wplywy(5).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOSKONALY, PrefixType.AKSAMITNE, Stats.builder().wyglad(4).obronaPrzedmiotow(-6).wplywy(6).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY, PrefixType.AKSAMITNE, Stats.builder().wyglad(3).obronaPrzedmiotow(-6).wplywy(5).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOBRY, PrefixType.AKSAMITNE, Stats.builder().wyglad(5).obronaPrzedmiotow(-6).wplywy(7).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOSKONALY, PrefixType.AKSAMITNE, Stats.builder().wyglad(6).obronaPrzedmiotow(-6).wplywy(9).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.EPICKI, PrefixType.AKSAMITNE, Stats.builder().wyglad(7).obronaPrzedmiotow(-6).wplywy(11).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.ZWYKLY, PrefixType.KOLCZE, Stats.builder().obronaPrzedmiotow(10).zwinnosc(-3).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOBRY, PrefixType.KOLCZE, Stats.builder().obronaPrzedmiotow(15).zwinnosc(-4).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOSKONALY, PrefixType.KOLCZE, Stats.builder().obronaPrzedmiotow(20).zwinnosc(-5).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY, PrefixType.KOLCZE, Stats.builder().obronaPrzedmiotow(14).zwinnosc(-4).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOBRY, PrefixType.KOLCZE, Stats.builder().obronaPrzedmiotow(21).zwinnosc(-6).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOSKONALY, PrefixType.KOLCZE, Stats.builder().obronaPrzedmiotow(27).zwinnosc(-7).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.EPICKI, PrefixType.KOLCZE, Stats.builder().obronaPrzedmiotow(34).zwinnosc(-8).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.ZWYKLY, PrefixType.KULOODPORNE, Stats.builder().odpornosc(4).twardosc(0.01).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOBRY, PrefixType.KULOODPORNE, Stats.builder().odpornosc(6).twardosc(0.02).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOSKONALY, PrefixType.KULOODPORNE, Stats.builder().odpornosc(8).twardosc(0.02).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY, PrefixType.KULOODPORNE, Stats.builder().odpornosc(6).twardosc(0.02).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOBRY, PrefixType.KULOODPORNE, Stats.builder().odpornosc(9).twardosc(0.03).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOSKONALY, PrefixType.KULOODPORNE, Stats.builder().odpornosc(11).twardosc(0.03).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.EPICKI, PrefixType.KULOODPORNE, Stats.builder().odpornosc(14).twardosc(0.05).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.ZWYKLY, PrefixType.GIETKI, Stats.builder().zwinnosc(4).obronaPrzedmiotow(-1).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOBRY, PrefixType.GIETKI, Stats.builder().zwinnosc(6).obronaPrzedmiotow(-1).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOSKONALY, PrefixType.GIETKI, Stats.builder().zwinnosc(8).obronaPrzedmiotow(-1).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY, PrefixType.GIETKI, Stats.builder().zwinnosc(6).obronaPrzedmiotow(-1).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOBRY, PrefixType.GIETKI, Stats.builder().zwinnosc(9).obronaPrzedmiotow(-1).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOSKONALY, PrefixType.GIETKI, Stats.builder().zwinnosc(11).obronaPrzedmiotow(-1).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.EPICKI, PrefixType.GIETKI, Stats.builder().zwinnosc(14).obronaPrzedmiotow(-1).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.ZWYKLY, PrefixType.PANCERNE, Stats.builder().obronaPrzedmiotow(14).twardosc(0.01).zwinnosc(-5).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOBRY, PrefixType.PANCERNE, Stats.builder().obronaPrzedmiotow(21).twardosc(0.02).zwinnosc(-6).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOSKONALY, PrefixType.PANCERNE, Stats.builder().obronaPrzedmiotow(28).twardosc(0.02).zwinnosc(-7).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY, PrefixType.PANCERNE, Stats.builder().obronaPrzedmiotow(19).twardosc(0.02).zwinnosc(-6).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOBRY, PrefixType.PANCERNE, Stats.builder().obronaPrzedmiotow(29).twardosc(0.03).zwinnosc(-8).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOSKONALY, PrefixType.PANCERNE, Stats.builder().obronaPrzedmiotow(38).twardosc(0.03).zwinnosc(-9).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.EPICKI, PrefixType.PANCERNE, Stats.builder().obronaPrzedmiotow(48).twardosc(0.05).zwinnosc(-10).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.ZWYKLY, PrefixType.KOMPOZYTOWE, Stats.builder().obronaPrzedmiotow(15).twardosc(0.01).zwinnosc(-4).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOBRY, PrefixType.KOMPOZYTOWE, Stats.builder().obronaPrzedmiotow(23).twardosc(0.02).zwinnosc(-5).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOSKONALY, PrefixType.KOMPOZYTOWE, Stats.builder().obronaPrzedmiotow(30).twardosc(0.02).zwinnosc(-6).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY, PrefixType.KOMPOZYTOWE, Stats.builder().obronaPrzedmiotow(21).twardosc(0.02).zwinnosc(-5).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOBRY, PrefixType.KOMPOZYTOWE, Stats.builder().obronaPrzedmiotow(32).twardosc(0.03).zwinnosc(-7).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOSKONALY, PrefixType.KOMPOZYTOWE, Stats.builder().obronaPrzedmiotow(41).twardosc(0.03).zwinnosc(-8).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.EPICKI, PrefixType.KOMPOZYTOWE, Stats.builder().obronaPrzedmiotow(52).twardosc(0.05).zwinnosc(-9).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.ZWYKLY, PrefixType.ELFIE, Stats.builder().zwinnosc(6).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOBRY, PrefixType.ELFIE, Stats.builder().zwinnosc(9).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOSKONALY, PrefixType.ELFIE, Stats.builder().zwinnosc(12).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY, PrefixType.ELFIE, Stats.builder().zwinnosc(8).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOBRY, PrefixType.ELFIE, Stats.builder().zwinnosc(12).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOSKONALY, PrefixType.ELFIE, Stats.builder().zwinnosc(16).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.EPICKI, PrefixType.ELFIE, Stats.builder().zwinnosc(20).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.ZWYKLY, PrefixType.RUNICZNE, Stats.builder().szczescie(5).obronaPrzedmiotow(10).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOBRY, PrefixType.RUNICZNE, Stats.builder().szczescie(8).obronaPrzedmiotow(15).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOSKONALY, PrefixType.RUNICZNE, Stats.builder().szczescie(10).obronaPrzedmiotow(20).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY, PrefixType.RUNICZNE, Stats.builder().szczescie(7).obronaPrzedmiotow(14).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOBRY, PrefixType.RUNICZNE, Stats.builder().szczescie(11).obronaPrzedmiotow(21).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOSKONALY, PrefixType.RUNICZNE, Stats.builder().szczescie(14).obronaPrzedmiotow(27).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.EPICKI, PrefixType.RUNICZNE, Stats.builder().szczescie(18).obronaPrzedmiotow(34).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.ZWYKLY, PrefixType.KRWAWY, Stats.builder().critMultiBiala1h(0.07).critMultiBiala2h(0.07).critMultiPalna1h(0.07).critMultiPalna2h(0.07).critMultiDystans1h(0.07).critMultiDystans2h(0.07).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOBRY, PrefixType.KRWAWY, Stats.builder().critMultiBiala1h(0.11).critMultiBiala2h(0.11).critMultiPalna1h(0.11).critMultiPalna2h(0.11).critMultiDystans1h(0.11).critMultiDystans2h(0.11).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.DOSKONALY, PrefixType.KRWAWY, Stats.builder().critMultiBiala1h(0.14).critMultiBiala2h(0.14).critMultiPalna1h(0.14).critMultiPalna2h(0.14).critMultiDystans1h(0.14).critMultiDystans2h(0.14).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY, PrefixType.KRWAWY, Stats.builder().critMultiBiala1h(0.1).critMultiBiala2h(0.1).critMultiPalna1h(0.1).critMultiPalna2h(0.1).critMultiDystans1h(0.1).critMultiDystans2h(0.1).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOBRY, PrefixType.KRWAWY, Stats.builder().critMultiBiala1h(0.15).critMultiBiala2h(0.15).critMultiPalna1h(0.15).critMultiPalna2h(0.15).critMultiDystans1h(0.15).critMultiDystans2h(0.15).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.LEGENDARNY_DOSKONALY, PrefixType.KRWAWY, Stats.builder().critMultiBiala1h(0.19).critMultiBiala2h(0.19).critMultiPalna1h(0.19).critMultiPalna2h(0.19).critMultiDystans1h(0.19).critMultiDystans2h(0.19).build()));
    prefixes.push(new Prefix(ItemGenre.LEGS, ItemRarity.EPICKI, PrefixType.KRWAWY, Stats.builder().critMultiBiala1h(0.25).critMultiBiala2h(0.25).critMultiPalna1h(0.25).critMultiPalna2h(0.25).critMultiDystans1h(0.25).critMultiDystans2h(0.25).build()));
  ...
  private static initializeArmourSuffix(playerLvl: number): Suffix[] {
    ...
    suffixes.push(new Suffix(ItemGenre.HEAD, ItemRarity.EPICKI, SuffixType.MISS, Stats.builder().sila(4).zwinnosc(4).odpornosc(4).wyglad(27).charyzma(4).wplywy(4).spostrzegawczosc(4).inteligencja(4).wiedza(4).build()));

    // Chest suffixes (sampled)
    suffixes.push(new Suffix(ItemGenre.CHEST, ItemRarity.ZWYKLY, SuffixType.MISS, Stats.builder().sila(1).zwinnosc(1).odpornosc(1).wyglad(8).charyzma(1).wplywy(1).spostrzegawczosc(1).inteligencja(1).wiedza(1).build()));
    suffixes.push(new Suffix(ItemGenre.CHEST, ItemRarity.DOBRY, SuffixType.MISS, Stats.builder().sila(2).zwinnosc(2).odpornosc(2).wyglad(12).charyzma(2).wplywy(2).spostrzegawczosc(2).inteligencja(2).wiedza(2).build()));
    suffixes.push(new Suffix(ItemGenre.CHEST, ItemRarity.ZWYKLY, SuffixType.ADRENALINY, Stats.builder().zwinnosc(4).spostrzegawczosc(-8).sila(3).build()));
    suffixes.push(new Suffix(ItemGenre.CHEST, ItemRarity.DOBRY, SuffixType.ADRENALINY, Stats.builder().zwinnosc(6).spostrzegawczosc(-8).sila(5).build()));
