...
import { MultiplicativeBonus, MultiplicativeBonusType } from '../interactions/MultiplicativeBonus';
...
static getArmourSet(type: SetType, rarity: ItemRarity, playerLvl: number): Set {
  ...
  private static initializeJewelerSets(playerLvl: number): Set[] {
    ...
    sets.push(new Set(SetType.TYTANOWY, ItemRarity.LEGENDARNY, Stats.builder().sila(16).odpornosc(19).zwinnosc(3).build(), [new MultiplicativeBonus(MultiplicativeBonusType.TYTAN, 1, 8, 1)]));
    sets.push(new Set(SetType.TYTANOWY, ItemRarity.LEGENDARNY_DOBRY, Stats.builder().sila(22).odpornosc(24).zwinnosc(5).build(), [new MultiplicativeBonus(MultiplicativeBonusType.TYTAN, 1, 6, 1)]));
    sets.push(new Set(SetType.TYTANOWY, ItemRarity.LEGENDARNY_DOSKONALY, Stats.builder().sila(30).odpornosc(29).zwinnosc(8).build(), [new MultiplicativeBonus(MultiplicativeBonusType.TYTAN, 1, 4, 1)]));
    sets.push(new Set(SetType.TYTANOWY, ItemRarity.EPICKI, Stats.builder().sila(40).odpornosc(35).zwinnosc(12).twardosc(0.30).build(), [new MultiplicativeBonus(MultiplicativeBonusType.TYTAN, 2, 6, 1)]));
    ...
    sets.push(new Set(SetType.CZARNY, ItemRarity.LEGENDARNY, Stats.builder().wplywy(14).odpornosc(10).critChanceBiala2h(0.20).ignoreObrony(0.15).zwinnosc(4).critMultiBiala2h(0.30).build(), [new MultiplicativeBonus(MultiplicativeBonusType.CZARNY, 1, 8, 1)]));
    sets.push(new Set(SetType.CZARNY, ItemRarity.LEGENDARNY_DOBRY, Stats.builder().wplywy(18).odpornosc(12).critChanceBiala2h(0.25).ignoreObrony(0.20).zwinnosc(6).critMultiBiala2h(0.60).build(), [new MultiplicativeBonus(MultiplicativeBonusType.CZARNY, 1, 6, 1)]));
    sets.push(new Set(SetType.CZARNY, ItemRarity.LEGENDARNY_DOSKONALY, Stats.builder().wplywy(24).odpornosc(14).critChanceBiala2h(0.28).ignoreObrony(0.30).zwinnosc(8).critMultiBiala2h(1.20).build(), [new MultiplicativeBonus(MultiplicativeBonusType.CZARNY, 1, 4, 1)]));
    sets.push(new Set(SetType.CZARNY, ItemRarity.EPICKI, Stats.builder().wplywy(30).odpornosc(20).critChanceBiala2h(0.35).ignoreObrony(0.40).zwinnosc(12).critMultiBiala2h(1.50).szczescie(25).build(), [new MultiplicativeBonus(MultiplicativeBonusType.CZARNY, 2, 6, 1)]));
