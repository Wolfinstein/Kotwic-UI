...
export const STAR_MOBS: StarMob[] = [
  ...
  { name: 'Agrameon', base: { zwinnosc: { min: 244, max: 329 }, spostrzegawczosc: { min: 196, max: 237 }, szczescie: { min: 0, max: 0 }, obrona: { min: 630, max: 780 }, odpornosc: { min: 630, max: 780 }, zycie: { min: 180000, max: 250000 } } },
  ...
  { name: 'Bokrug', base: { zwinnosc: { min: 434, max: 546 }, spostrzegawczosc: { min: 196, max: 308 }, szczescie: { min: 45, max: 85 }, obrona: { min: 480, max: 732 }, odpornosc: { min: 180, max: 282 }, zycie: { min: 400000, max: 520000 } } },
